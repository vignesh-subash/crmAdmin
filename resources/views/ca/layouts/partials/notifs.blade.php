					...
					<li class="dropdown user user-menu">
						...
						<ul class="dropdown-menu">
							...
							<li class="user-body">
								...
								<div class="col-xs-6 text-center mb10">
									<a href="{{ url(config('crmadmin.adminRoute') . '/ca_menus') }}"><i class="fa fa-bars"></i> <span>Menus</span></a>
								</div>
								<div class="col-xs-6 text-center mb10">
									<a href="{{ url(config('crmadmin.adminRoute') . '/ca_configs') }}"><i class="fa fa-cogs"></i> <span>Configure</span></a>
								</div>
